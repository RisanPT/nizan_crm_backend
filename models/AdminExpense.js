...
export const EXPENSE_HEADS = [
  ...
  { code: 'TEL-01', label: 'Telephone & Internet Charges', group: 'Operating Expense', recurring: true },
  ...
  { code: 'PRN-01', label: 'Printing & Stationery Charges', group: 'Operating Expense' },
  { code: 'TRN-01', label: 'Training & Recruitment Expenses', group: 'Employee / Operating' },
  { code: 'WEL-01', label: 'Staff Welfare Expenses', group: 'Employee Benefit' },
  { code: 'PRD-01', label: 'Product Purchase', group: 'COGS / Direct Purchase', jobLinked: true },
  // Contra-revenue, not a plain expense — sales returns post as credit notes.
  { code: 'SRT-01', label: 'Sales Return – Credit Note', group: 'Contra-Revenue', nature: 'income', jobLinked: true },
  { code: 'OFF-01', label: 'Office Expense', group: 'Operating Expense' },
  { code: 'RNT-01', label: 'Rent – Office Expense', group: 'Rent', recurring: true },
  { code: 'RNT-02', label: 'Additional Rent Expenses', group: 'Rent', recurring: true },
